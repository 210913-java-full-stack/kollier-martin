...
DROP CONSTRAINT AJUNC_FK;

ALTER TABLE CUSTOMERS 
DROP CONSTRAINT CJUNC_FK,
DROP CONSTRAINT C_USERNAME;
...
(
    ...
    CONSTRAINT C_USERNAME FOREIGN KEY (USER_ID) REFERENCES USERINFO(USER_ID)
);
...
(
	...
	CONSTRAINT T_FK FOREIGN KEY (ACCOUNT_ID) REFERENCES ACCOUNTS(ACCOUNT_ID)
);